...
local ConfigFileName = "COW_HUB_Config.json"
...
local DISCORD_TEXT = "discord.gg/DSTJYFv3BW"
...
-- Typing animation for "Cow Duels HUB"
local fullText = "Cow Duels HUB"
...
subtitleLabel.Text = "discord.gg/DSTJYFv3BW"
